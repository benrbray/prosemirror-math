...
// project imports
import mathSelectPlugin from "./src/plugins/math-select";
import { mathInputRules } from "./src/plugins/math-inputrules";
import { editorSchema } from "./src/math-schema";
import { MathView, ICursorPosObserver } from "./src/math-nodeview";
import { mathBackspace } from "./src/plugins/math-backspace";
import { mathPlugin } from "./src/math-plugin";
